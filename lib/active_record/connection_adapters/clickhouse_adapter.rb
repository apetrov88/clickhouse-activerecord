...
module ActiveRecord
  ...
  module ConnectionAdapters
    ...
    class ClickhouseAdapter < AbstractAdapter
      ...
      def connect
        @connection = Net::HTTP.start(@connection_parameters[0], @connection_parameters[1], use_ssl: @connection_parameters[2],  read_timeout: @config[:read_timeout] || 120, verify_mode: OpenSSL::SSL::VERIFY_NONE)
      end
    end
  end
end
